...
/**
 * Service permitting to compute the difference between two given strings represented by {@link
 * DiffRequest} object.
 * 
 * @author houlachguer
 */
...
public interface Differentiator {
   ...
   *
   * The method assumes that the request is validated, i.e no extra validation is going to be
   * performed. The assumption is that none of the strings are {@code null}.
   *
   * @param request The target strings
   * @return a new instance of {@link DiffResult}. If new difference can be found, a diff result
